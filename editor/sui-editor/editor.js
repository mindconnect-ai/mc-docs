 ...
 */
export async function bootEditor(opts = {}) {
    if (opts.backend)
    ...
    const statusEl = root.querySelector(".sui-editor-status");
    const saveBtn = root.querySelector(".sui-editor-save");
    const exitBtn = root.querySelector(".sui-editor-exit");
    const previewBtn = root.querySelector(".sui-editor-preview-btn");
    const treeHost = root.querySelector(".sui-editor-tree");
    const panelHost = root.querySelector(".sui-editor-panel");
    const previewHost = root.querySelector(".sui-editor-preview");
...
function layoutHtml(title, withExit, withPreview) {
    const exit = withExit
    ...
    const preview = withPreview
        ...
        : ``;
    return (`<div class="sui-editor-toolbar">` +
        exit +
